...
import ProductionPackStudio from '../components/director/ProductionPackStudio'
...
export default function DirectorStudio() {
  ...
  return <main className="min-h-[100dvh] workbench-shell p-4 md:p-6"><div className="max-w-7xl mx-auto space-y-4">
    ...
    {tab === 'packs' && <ProductionPackStudio packs={packs} publishedSkills={publishedSkills} onChanged={refresh} onUse={packId => navigate('/director?pack=' + encodeURIComponent(packId))}/>}\n  </div></main>
}
